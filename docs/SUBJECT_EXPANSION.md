...
| 憲法 | 法學知識與英文中的中華民國憲法部分 | 待擴充 |
| 法學緒論 | 法學知識與英文中的法學緒論部分 | 待擴充 |
| 英文 | 法學知識與英文中的英文部分 | 待擴充 |
...
題目與答案以考選部共用試卷為準。單字、文法與閱讀解析可查可靠字典或文法資料，但不得複製其例句、定義或第三方逐題解析。英文長文可能含改寫素材；保留官方試題必要文字即可，不額外搬運來源全文，中文翻譯必須自行撰寫。
