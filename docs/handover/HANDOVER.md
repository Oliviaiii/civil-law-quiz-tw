...
### 種子內容進度（本文件產出時：48／300 題完成並通過或待驗證）
| 批次 | 完成 | 批次 | 完成 |
|---|---|---|---|
| 憲法 105 | 15/15 ✅ | 法緒 105 | 10/15 |
| 憲法 106 | 2/15 | 法緒 106 | 0/15 |
...
### 精確缺題清單（252 題，官方題號；id 格式 `judicial-fourth-<年>-legal-knowledge-<兩位數題號>`）
- 憲法 105 年：✅ 全數完成
- 憲法 106 年：缺第 3～15 題
- 憲法 107 年：缺第 3～15 題
...
- **一次只跑一個批次**（30 題），跑完再開下一批（使用者明確要求，怕用量爆掉）。順序：憲法 106 剩餘 → 法緒 105 剩餘 → 法緒 106 → 憲法 107…（105–106 優先，其餘照年度）。
